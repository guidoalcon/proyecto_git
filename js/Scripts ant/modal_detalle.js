		...
		function verResolucion(nro_a,nro_b){
			        ...
			        light = new LightFace.IFrame({ height:300, width:520, url: '../../views/resoluciones/informacion_resolucion_b.php?nrA='+nro_a+'&nrB='+nro_b, title: 'INFORMACIÓN DE RESOLUCIÓN' }).addButton('Cerrar', function() { light.close(); },true).open();     	
